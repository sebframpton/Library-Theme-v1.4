        ...
        <div class="orbit text-center" role="region" aria-label="Favorite Space Pictures" data-orbit
          ...
          <ul class="orbit-container">
            ...
            <li class="is-active orbit-slide">
              <img class="orbit-image" src="<?php echo get_template_directory_uri() ?>/assets/img/Book.jpg" alt="l" style="width:1170px;height:487.500px;">
              <figcaption class="orbit-caption"><a href="categories.html">Newest Art Books</a></figcaption>
            </li>
            <li class="orbit-slide">
              <img class="orbit-image" src="<?php echo get_template_directory_uri() ?>/assets/img/Landscape-picture.jpeg" alt="Space"
                style="width:1170px;height:487.500px;">
              <figcaption class="orbit-caption"><a href="categories.html">Modern Art Books</a></figcaption>
            </li>
            <li class="orbit-slide">
              <img class="orbit-image" src="<?php echo get_template_directory_uri() ?>/assets/img/sunrise.jpg" alt="Space" style="width:1170px;height:487.500px;">
              <figcaption class="orbit-caption"><a href="categories.html">Renainassance Art Books</a></figcaption>
            </li>
            <li class="orbit-slide">
              <img class="orbit-image" src="<?php echo get_template_directory_uri() ?>/assets/img/Lion.jpg" alt="Space" style="width:1170px;height:487.500px;">
          ...
          <div class="tabs-content" data-tabs-content="collapsing-tabs">
            <div class="tabs-panel is-active" id="panel1">
              <div class="media-object stack-for-small">
                <div class="media-object-section">
                  <div class="tab-image">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/img/The Renaissance.jpg" style="width: 250px; height: 350px;">
                  </div>
                </div>
                <div class="media-object-section">
                  ...
                  <ul style="list-style:none;">
                    <li>
                      ...
                      <div class="reveal book1" id="exampleModal1" data-reveal data-overlay="true">
                        ...
                        <div class="media-object-section">
                          <div class="tab-image">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Renaissance Art Reconsidered.jpg" style="width: 150px;">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Library Map2.jpg" alt="" style="width: 250px;">
                          </div>
                          <p>
                            Author:
                            Richardson, Carol M.
                    ...
                    <li>
                      ...
                      <div class="reveal book2" id="exampleModal2" data-reveal data-overlay="true">
                        ...
                        <div class="media-object-section">
                          <div class="tab-image">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Art and Society.jpg" style="width: 150px;">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Library Map2.jpg" alt="" style="width: 250px;">
                          </div>
                          <p>
                            Author:
                    ...
                    <li>
                      ...
                      <div class="reveal book3" id="exampleModal3" data-reveal data-overlay="true">
                        ...
                        <div class="media-object-section">
                          <div class="tab-image">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/the History of Art.jpg" style="width: 150px;">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Library Map2.jpg" alt="" style="width: 250px;">
                          </div>
                          <p>
                            Author:Hodge, D.N.
            ...
            <div class="tabs-panel" id="panel2">
              <div class="media-object stack-for-small">
                <div class="media-object-section">
                  <div class="tab-image">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/img/Twentieth Century.jpg" style="width: 250px; height: 350px;">
                  </div>
                </div>
                <div class="media-object-section">
                  ...
                  <ul style="list-style:none;">
                    ...
                    <li>
                      ...
                      <div class="reveal book4" id="exampleModal4" data-reveal data-overlay="true">
                        ...
                        <div class="media-object-section">
                          <div class="tab-image">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Visual Arts in Twentieth C.jpg" style="width: 150px;">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Library Map2.jpg" alt="" style="width: 250px;">
                          </div>
                          <p>
                            Author:
                    ...
                    <li>
                      ...
                      <div class="reveal book5" id="exampleModal5" data-reveal data-overlay="true">
                        ...
                        <div class="media-object-section">
                          <div class="tab-image">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/After Modern Art.jpg" style="width: 150px;">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Library Map2.jpg" alt="" style="width: 250px;">
                          </div>
                          <p>
                            Author:
                    ...
                    <li>
                      ...
                      <div class="reveal book6" id="exampleModal6" data-reveal data-overlay="true">
                        ...
                        <div class="media-object-section">
                          <div class="tab-image">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Modern Art Book PostModern.jpg" style="width: 150px;">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Library Map2.jpg" alt="" style="width: 250px;">
                          </div>
                          <p>
                            Author:
            ...
            <div class="tabs-panel" id="panel3">
              <div class="media-object stack-for-small">
                <div class="media-object-section">
                  <div class="tab-image">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/img/Twenty First Century.jpg" style="width: 250px; height: 350px;">
                  </div>
                </div>
                <div class="media-object-section">
                  ...
                  <ul style="list-style:none;">
                    <li>
                      ...
                      <div class="reveal book7" id="exampleModal7" data-reveal data-overlay="true">
                        ...
                        <div class="media-object-section">
                          <div class="tab-image">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Art 21.jpg" style="width: 150px;">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Library Map.jpg" alt="" style="width: 250px;">
                          </div>
                          <p>
                            Author:
                            Golden, Thelma.
                    ...
                    <li>
                      ...
                      <div class="reveal book8" id="exampleModal8" data-reveal data-overlay="true">
                        ...
                        <div class="media-object-section">
                          <div class="tab-image">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/WordisArt.jpg" style="width:150px;">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Library Map.jpg" alt="" style="width: 250px;">
                          </div>
                          <p>
                            Author:
                    ...
                    <li>
                      ...
                      <div class="reveal book9" id="exampleModal9" data-reveal data-overlay="true">
                        ...
                        <div class="media-object-section">
                          <div class="tab-image">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Contempery.jpg" style="width: 150px;">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Library Map.jpg" alt="" style="width: 250px;">
                          </div>
                          <p>
                            Author:
